...
var switchColorBackGround = Get.isDarkMode ? white : darkGreyClr;

class SignUpScreen extends StatelessWidget {
  //Form widgeti icinde key ozelligi var ona formKey degiskeni atiyoz.her TextField icinde kurallar var adi,email veya password yanlis yada eksik bi seklide yazsak textFild tam altinda hatayi gostermek icin bunlari kullanacz.
...
//Get paketi kullanarki veGetPage binding ozellige bu classi attik AuthController classi ve icindeki methodulari bu sayfada kullanmk icin bu sekilde bulup cagiriyoz
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor:
      context.theme.backgroundColor, //eger darkModi secili ise yani dogru ise white gosterck degilse siyah gosterck ve boylece
      appBar: AppBar(
              ...
              children: [
                ...
                AuthTextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (value.toString().length < 2 ||
                      ...
                      //kullanici tarafindan girilen value/name Regular Expression kurallarina esit degilse(!) demeki yanlis ve su islemi yap. ve Form widgeti sayesinde hatayi TextField altinda gostercz
                ...
                AuthTextFormField(
                  ...
                  validator: (value) {
                    if (value.toString().length < 2 ||
                      ...
                      //kullanici tarafindan girilen value/email Regular Expression kurallarina esit degilse(!) demeki yanlis ve su islemi yap ve Form widgeti sayesinde hatayi TextField altinda gostercz.
                ...
                GetBuilder<AuthController>(builder: (_) {
                  return ElevatedAuthButton(
                    text: 'SIGN UP',
                    onPressed: () {
                      if(controller.isCheckBox==true) {//eger checkBox secili ise asgdaki islemleri yap degilse snackBar olark bi uyari goster
                      ...
                      if (formKey.currentState!.validate()) {
                        String name = nameController.text.trim();//trim() The string without any leading and trailing whitespace.yani solda veya sagda boslukl varsa onu kaldir ve deam et
                        ...
                        Get.snackbar('Waring', 'Please You have to accept terms & conditions',snackPosition: SnackPosition.BOTTOM,backgroundColor: mainColor);
                      } }
                  );
                }),
                const SizedBox(
